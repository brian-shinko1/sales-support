    ...
    <div className="min-h-full flex items-center justify-center">
      <div className="flex flex-col items-center gap-6 w-full max-w-sm px-6">
        <div className="text-center">
          <h1 className="text-2xl font-semibold tracking-tight">Sales Support</h1>
        ...
        <a
          href="/api/auth/login"
          className="flex items-center justify-center gap-3 w-full rounded-lg py-2.5 px-4 bg-white text-zinc-900 text-sm font-medium hover:bg-zinc-100 transition-colors"
        >
